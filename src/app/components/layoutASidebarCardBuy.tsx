...
export const LayoutASidebarCardBuy = ({ item }: { item: IStock }) => {
  // store
  ...
  return (
    <Card
      className="w-[360px] p-2 flex flex-col gap-1 cursor-pointer bg-sky hover:bg-sky-foreground"
          ...
          <div className="whitespace-nowrap overflow-hidden text-ellipsis flex flex-col">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs">
                (
                {(
                  ((Number(item?.buyData?.price) - Number(item?.close)) /
