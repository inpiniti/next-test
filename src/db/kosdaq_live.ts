...
export const kosdaqLiveTable = pgTable('kosdaq_live', {
  ...
  full_model_1h_prediction: numeric('full_model_1h_prediction'),
  full_model_2h_prediction: numeric('full_model_2h_prediction'),
  full_model_3h_prediction: numeric('full_model_3h_prediction'),
  full_model_4h_prediction: numeric('full_model_4h_prediction'),
  full_model_5h_prediction: numeric('full_model_5h_prediction'),
  full_model_6h_prediction: numeric('full_model_6h_prediction'),
  full_model_7h_prediction: numeric('full_model_7h_prediction'),
  full_model_8h_prediction: numeric('full_model_8h_prediction'),
  full_model_9h_prediction: numeric('full_model_9h_prediction'),
  full_model_10h_prediction: numeric('full_model_10h_prediction'),
  full_model_11h_prediction: numeric('full_model_11h_prediction'),
  full_model_12h_prediction: numeric('full_model_12h_prediction'),
  full_model_13h_prediction: numeric('full_model_13h_prediction'),
  full_model_14h_prediction: numeric('full_model_14h_prediction'),
  full_model_15h_prediction: numeric('full_model_15h_prediction'),
  full_model_16h_prediction: numeric('full_model_16h_prediction'),
  full_model_17h_prediction: numeric('full_model_17h_prediction'),
  full_model_18h_prediction: numeric('full_model_18h_prediction'),
  full_model_19h_prediction: numeric('full_model_19h_prediction'),
  full_model_20h_prediction: numeric('full_model_20h_prediction'),
  full_model_21h_prediction: numeric('full_model_21h_prediction'),
  full_model_22h_prediction: numeric('full_model_22h_prediction'),
  full_model_23h_prediction: numeric('full_model_23h_prediction'),
});
